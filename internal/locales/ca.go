...
var ca = Locale{
	...
	AuthorizedResponseBody:              "<!DOCTYPE html><html lang=\"ca\"><head><meta charset=\"UTF-8\"><title>Racó Bot</title></head><body><h1>Autoritzat</h1><p>Pots tancar el navegador i tornar a Telegram.</p></body></html>",
