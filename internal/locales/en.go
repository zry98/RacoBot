...
var en = Locale{
	...
	LogoutSucceededMessage:              "You have successfully logged-out! And the FIB API token has been revoked on server, you can use /login to re-authorize.",
	...
	FIBAPIAuthorizationExpiredMessage:   "<i>Authorization has expired, please /login again.</i>",
