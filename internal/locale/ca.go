...
var ca = Locale{
	...
	BannerNoticesMutedMessage:           "Has silenciat els avisos de banner (aquells que no són d'assignatures, per exemple, eleccions), pots reactivar les notificacions amb /unmute_banner_notices.",
	BannerNoticesUnmutedMessage:         "Has activat les notificacions dels avisos de banner (aquells que no són d'assignatures, per exemple, eleccions), pots silenciar-los amb /mute_banner_notices.",
	...
	CommandsMenu: []tb.Command{
		...
		{Text: "unmute_banner_notices", Description: "Activar notificacions d'avisos de banner"},
