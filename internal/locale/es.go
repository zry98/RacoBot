...
var es = Locale{
	...
	BannerNoticesMutedMessage:           "Has silenciado los avisos de banner (aquellos que no son de asignaturas, por ejemplo, elecciones), puedes reactivar las notificaciones con /unmute_banner_notices.",
	BannerNoticesUnmutedMessage:         "Has activado las notificaciones de los avisos de banner (aquellos que no son de asignaturas, por ejemplo, elecciones), puedes silenciarlos con /mute_banner_notices.",
	...
	CommandsMenu: []tb.Command{
		...
		{Text: "mute_banner_notices", Description: "Silenciar avisos de banner"},
		{Text: "unmute_banner_notices", Description: "Activar notificaciones de avisos de banner"},
