...
var en = Locale{
	...
	BannerNoticesMutedMessage:           "You have muted the banner notices (those not of subjects, e.g., elections), you can unmute them by /unmute_banner_notices.",
	BannerNoticesUnmutedMessage:         "You have unmuted the banner notices (those not of subjects, e.g., elections), you can mute them by /mute_banner_notices.",
	...
	CommandsMenu: []tb.Command{
		...
		{Text: "mute_banner_notices", Description: "Mute banner notices"},
		{Text: "unmute_banner_notices", Description: "Unmute banner notices"},
